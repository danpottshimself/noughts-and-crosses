...
.controller('MyController', ['$scope','$q', 'Proxy','GameFunctions', 'CoreData','CharacterLogic','PlayerService','Characters', function ($scope,$q, proxy, gameFunctions, coreData, characterLogic, playerService, characters) {
